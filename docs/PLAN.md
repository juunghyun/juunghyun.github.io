...
| 글 | 소재 뼈대 제안, 재현 코드 작성·실행 검증, 발행 체크리스트, PR·배포 | 한국어 초안, 영어 번역, 윤문, 최종 승인 |
...
| 1.6 | 글 1: 블로그 구축기 | Claude 뼈대, 필자 문장·번역 | 이 작업 기록으로 뼈대를 만들고 필자가 고쳐 쓴다. 번역·윤문, 체크리스트, PR | 10-12 발행 |
